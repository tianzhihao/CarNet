...
import cn.edu.qtc.adapter.TS_List_Adapter;
...
public class CityList extends Activity {
	...
	private TS_List_Adapter mAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ts_citys);
		...
		mAdapter = new TS_List_Adapter(this, getData(provinceId));
	...
	private List<ListModel> getData(String provinceId) {
		...
		txtListTip.setText(provinceName + "已开通" + cityList.size()
				+ "个城市, 其它城市将陆续开放");
