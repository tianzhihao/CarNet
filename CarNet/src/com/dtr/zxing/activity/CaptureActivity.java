...
//		startActivity(new Intent(CaptureActivity.this, ResultActivity.class).putExtras(bundle));
		CaptureActivity.this.setResult(RESULT_OK,new Intent().putExtras(bundle));
//		Toast.makeText(CaptureActivity.this, bundle.getString("result"), Toast.LENGTH_SHORT).show();
